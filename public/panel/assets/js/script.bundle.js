...
function readURL1(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview1').css('background-image', 'url('+e.target.result +')');
...
function readURL2(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview2').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview2').hide();
        jQuery('#imagePreview2').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
function readURL3(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview3').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview3').hide();
        jQuery('#imagePreview3').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
function readURL4(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview4').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview4').hide();
        jQuery('#imagePreview4').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
function readURL5(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview5').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview5').hide();
        jQuery('#imagePreview5').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
function readURL6(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview6').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview6').hide();
        jQuery('#imagePreview6').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
function readURL7(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview7').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview7').hide();
        jQuery('#imagePreview7').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
function readURL8(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function(e) {
        jQuery('#imagePreview8').css('background-image', 'url('+e.target.result +')');
        jQuery('#imagePreview8').hide();
        jQuery('#imagePreview8').fadeIn(650);
      }
      reader.readAsDataURL(input.files[0]);
  }
}
...
jQuery("#imageUpload3").change(function() {
  readURL3(this);
});
jQuery("#imageUpload4").change(function() {
  readURL4(this);
});
jQuery("#imageUpload5").change(function() {
  readURL5(this);
});
jQuery("#imageUpload6").change(function() {
  readURL6(this);
});
jQuery("#imageUpload7").change(function() {
  readURL7(this);
});
jQuery("#imageUpload8").change(function() {
  readURL8(this);
});
